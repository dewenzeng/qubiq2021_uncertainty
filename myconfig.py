...
parser.add_argument("--dataset", type=str, default='brain-tumor', help='can be brain-growth, brain-tumor, kidney, pancreas, pancreatic-lesion, prostate')
parser.add_argument("--task", type=str, default='task03')
...
# parser.add_argument("--pretrained_model_path", type=str, default='./results/brain-tumor_task02_2021-08-13_13-47-59/model/best_model.pth')
parser.add_argument("--pretrained_model_path", type=str, default='./results/brain-tumor_task03_2021-08-13_05-42-39/model/latest.pth')
